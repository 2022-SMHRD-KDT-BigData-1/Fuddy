		...
		<div id="carouselExampleDark" class="carousel carousel-dark slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active" data-bs-interval="10000">
					<img src="resources/image/img01_logo.jpg" class="d-block w-100"
						alt="">
				...
				<div class="carousel-item" data-bs-interval="2000">
					<img src="resources/image/img02_logo.jpg" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
				...
				<div class="carousel-item">
					<img src="resources/image/img03_logo.jpg" class="d-block w-100"
						alt="...">
					<div class="carousel-caption d-none d-md-block">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					...
					<p style="text-align: center">사용자가 보내는 사진에서 병해충을 실시간으로 판단해줍니다.
					</p>
