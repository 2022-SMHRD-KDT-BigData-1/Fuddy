...
<body>
	...
	<div class="container p-3 my-3 border">
		...
		<form action="http://f2.project-jupyter.ddns.net:8872/yolov5"
			method="POST">
			...
			<input type="hidden" value="http://44.203.185.159:8080/files/"
				name="path"> <input type="hidden" value="${info.u_id }"
				name="u_id"> <input type="hidden" value="${date }"
				name="p_date"> <input type="hidden" value="${folder }"
				name="p_folder">
