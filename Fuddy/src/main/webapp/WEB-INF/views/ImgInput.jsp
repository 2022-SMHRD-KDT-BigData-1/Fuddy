  ...
  <body>
    ...
    <div class="container p-3 my-3 border">
      ...
      <div class="input-group">
        ...
        <input type="file" multiple class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">

        <figure class="text-end">
          <blockquote class="blockquote">
            <p style="color: #f0932b;">※ 사진에 작물의 크기가 너무 작을 시 확인이 안될 수 있습니다. </p>
            
          </blockquote>
        </figure>
        <p>좋은예시 </p>
        <div><img src="leaf01.jpg" class="rounded d-block w-50" ></div>
        <div class="mt-3" style="text-align: center;">
         <a href = "ImgCheck.do"><button  class="btn btn-outline-success" type="button" id="inputGroupFileAddon04">사진확인</button></a>
      </div>
