		...
		<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
			<li class="nav-item" role="presentation">
				<button class="nav-link active btn btn-outline-success"
					...
					aria-controls="pills-home" aria-selected="true">회원</button>
			</li>
			<li class="nav-item" role="presentation">
				<button class="nav-link btn btn-outline-success"
					id="pills-profile-tab" data-bs-toggle="pill"
					data-bs-target="#pills-profile" type="button" role="tab"
					aria-controls="pills-profile" aria-selected="false">직원</button>
			</li>
		...
		<div class="tab-content" id="pills-tabContent">
			<div class="tab-pane fade show active" id="pills-home"
				...
				<form action="loginSelect.do" class="was-validated">
					...
					<div class="form-group">
						<label for="id_f">ID </label> <input type="text"
							class="form-control" id="u_id" placeholder="ID를 입력해주세요"
							name="u_id" required />
			...
			<div class="tab-pane fade" id="pills-profile" role="tabpanel"
				...
				<form action="dlogin.do" class="was-validated">
					...
					<div class="form-group">
						<label for="id_d">ID </label> <input type="text"
							class="form-control" id="admin_id" placeholder="ID를 입력해주세요"
					...
					<div class="form-group">
						<label for="pw_d">비밀번호 </label> <input type="password"
							class="form-control" id="admin_pw" placeholder="비밀번호를 입력해주세요"
