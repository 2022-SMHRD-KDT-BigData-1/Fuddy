...
<body>
								...
								<c:otherwise>
									...
									<li class="nav-item dropdown"><a
										...
										role="button" data-bs-toggle="dropdown" aria-expanded="false">
											방제신청내역 </a>
										<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											<li><a class="dropdown-item" href="#">기본
													정보</a></li>
											<li><a class="dropdown-item" href="#">내역
													수정</a></li>
	...
	<div class="container p-3 my-3 border" style="width: 350px">
		...
		<form action="joinInsert.do" method="post" class="was-validated">
			...
			<div class="form-group">
				<label for="tel">영업 거점 </label> <input type="text"
					class="form-control" data-format="ddd-dddd-dddd" id="u_addr"
					placeholder="주소을 입력해주세요" name="u_addr" required />
