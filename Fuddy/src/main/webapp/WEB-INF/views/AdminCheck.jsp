...
<body>
	...
	<div class="container p-3 my-3 border" style="width: 350px">
		<!-- 회원수정 내용 -->
		<h5 style="text-align: center">직원조회 및 수정</h5>
		<hr />
		<form action="#" class="was-validated">
			...
			<div class="form-group">
				<label for="tel">거점 </label> <input type="text" class="form-control"
					data-format="ddd-dddd-dddd" id="u_address" placeholder="u_address"
					name="u_address" required />
				<div class="valid-feedback">유효한 거점입니다.</div>
				<div class="invalid-feedback">거점 칸을 바꿔주세요.</div>
			</div>
			<br />
			<div class="form-group">
				<label for="tel">자격증 </label> <input type="text"
					class="form-control" data-format="ddd-dddd-dddd" id="u_email"
					placeholder="u_email" name="u_email" required />
				<div class="valid-feedback">유효한 자격증 입니다.</div>
				<div class="invalid-feedback">자격증 칸을 바꿔주세요.</div>
			</div>
