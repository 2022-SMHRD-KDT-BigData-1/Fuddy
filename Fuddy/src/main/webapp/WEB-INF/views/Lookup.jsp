				...
				<form action="#" style="text-align: center">
					...
					<table class="table" style="text-align: center">
						...
						<tr>
							...
							<td class="table-active">병해충</td>
							<td><input type="text" name="pv_disease" value="${j.pv_disease }" /></td>
						</tr>
						<tr>
							<!-- map API -->
							<td colspan="4">map API</td>
						...
						<tr>
							<td class="table-active">방제날짜</td>
							<td colspan="3"><span> 
							<input type="date" name="pv_st_dt" class="date" value="${j.pv_st_dt }" /></span> ~ <span> 
						...
						<tr>
							<td class="table-active">특이사항</td>
							<td colspan="3"><textarea  name ="pv_ed_dt" style="width: 100%">${j.pv_ed_dt }</textarea></td>
						</tr>
